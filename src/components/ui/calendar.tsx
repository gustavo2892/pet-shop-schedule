...
function Calendar({
  ...
  return (
    <DayPicker
      ...
      classNames={{
        root: cn('w-fit border border-border-primary', defaultClassNames.root),
        months: cn(
        ...
        month_caption: cn(
          'flex items-center justify-center h-(--cell-size) w-full px-(--cell-size) text-content-primary',
        ...
        weekday: cn(
          'text-muted-foreground rounded-md flex-1 font-normal text-[0.8rem] select-none text-content-primary',
        ...
        today: cn('bg-accent-primary text-white', defaultClassNames.today),
        outside: cn(
